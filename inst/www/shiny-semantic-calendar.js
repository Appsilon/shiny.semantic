...
$.extend(semanticDateBinding, {
  ...
  subscribe: function(el, callback) {
    $(el).on('keyup.semanticDateBinding input.semanticDateBinding', function(event) {
      // Use normal debouncing policy when typing
      callback(true);
    });
    $(el).on('changeDate.semanticDateBinding change.semanticDateBinding', function(event) {
