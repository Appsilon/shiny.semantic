var semanticRadioGroupBinding = new Shiny.InputBinding();

$.extend(semanticRadioGroupBinding, {
  find: function(scope) {
    return $(scope).find('.ss-input-radiogroup');
  },
  ...
  subscribe: function(el, callback) {
    $(el).on('change.semanticRadioGroupBinding', function(event) {
      callback();
    });
  },

  unsubscribe: function(el) {
    $(el).off('.semanticRadioGroupBinding');
  },

  // Get the DOM element that contains the top-level label
  _getLabelNode: function(el) {
      return $(el).parent().find('label[for="' + el.id + '"]');
  },
...
Shiny.inputBindings.register(semanticRadioGroupBinding, 'shiny.semanticRadioGroup');
