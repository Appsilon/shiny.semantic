...
<br>
<center>
```{r, echo = FALSE, message = FALSE, fig.height = 1, fig.width = 4.5, screenshot.force = TRUE}
...
<br>
<center>
```{r, echo = FALSE, message = FALSE, fig.height = 1, fig.width = 5.5, screenshot.force = TRUE}
...
<center>
```{r, echo = FALSE, fig.height = 1.5, fig.width = 2, screenshot.force = TRUE}
example_button = create_example(div(class = "ui button", uiicon("user"),  "Icon button"), width = "100%", height = "100px")
...
```{r, echo = FALSE, fig.height = 1.7, screenshot.force = TRUE}
...
<center>
```{r, echo = FALSE, fig.width = 4, screenshot.force = TRUE}
