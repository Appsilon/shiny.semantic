---
title: shiny.semantic documentation
...
With this library it's easy to wrap Shiny components into SemanticUI components. 
...
All dashboard source code can be found in **/demo** folder.
