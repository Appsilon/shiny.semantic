...
With this library it's easy to wrap Shiny with [Semantic UI components][semantic_repo_url]. Add few simple lines of code and some CSS classes to give your UI a fresh, modern and highly interactive look.
...
The source code for the [Live components demo](`r params$demo_url`) is located in **/examples** folder. To run it locally you will have to install:
...
2. Installing specific dependent libraries versions
    * shiny
    ...
    ```
3. Some bugs may be realted directly to Semantic UI. In that case please try to check issues on its [repository.][semantic_repo_url]
