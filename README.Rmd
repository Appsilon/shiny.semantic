...
* [Static Semantic components demo](https://github.com/Appsilon/shiny.semantic/blob/develop/examples/app.R)
...
* [Shiny fileInput demo](https://github.com/Appsilon/shiny.semantic/blob/develop/examples/shiny_syntax/fileInput.R)
...
* [Notification demo](https://github.com/Appsilon/shiny.semantic/blob/develop/examples/toast/app.R)
