---
# Question filip is it actually ok. Without this option I couldn't generate Markdown file.
...
demo <- function(code) {
  div(class = "demo ui raised segment",
    code,
    div(style = "width: 100%; height:10px"),
    highlighter::highlight(formatR::tidy_source(output = FALSE, width.cutoff = 40, text = deparse(substitute(code)))$text.tidy)
  )
}
```
...
TODO Chris - write about invoking specific components JS, found in SemanticUI documentation.
...
* [**highlighter**](TODO Filip repo url)
```
